"""Product or Service Not Received Category Rubric Definition."""
...
PNR_CATEGORY = {
    ...
    "required_evidence": [
        {
            "item_id": "proof_of_delivery_or_digital_access",
            "name": "Proof of Delivery / Courier Tracking / Digital Access Log",
            "weight": 40.0,
            ...
            "strong_evidence_indicators": [
                ...
                "Digital service / account accessed and utilized post-transaction date",
            ...
            "weak_evidence_indicators": [
                ...
                "Zero login or digital activation activity recorded"
            ]
        },
        {
